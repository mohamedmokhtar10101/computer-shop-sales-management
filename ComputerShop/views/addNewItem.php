...
?>
        ...
        <form class="formSection" id="addNewItem" name="addNewItem" method="post" action="?page=controllers/addnewItem_c" autocomplete="on" enctype="multipart/form-data">
            ...
            <label for="itemDPrice">Item Dealer Price</label><input id="itemDPrice" class="<?php  $st = ";document.getElementsByClassName('errorSpans')[6].innerHTML = ' '";$st1="this.className ='recoveryFields'" ;if(!empty($errorsMessages["d_price"]))echo "errorFields\"oninput = \"$st1$st\"";?>" name="d_price" type="text"  placeholder="Enter dealer price here !" onfocus="this.placeholder=''" onblur="this.placeholder='Enter  dealer price here !'" value="<?php if($errorsMessages['d_price']==null)echo $itemsToAdd['d_price']; if($edit == true)  echo $itemToDisplay['d_price'];?>"><span class="parentSpan"><span class="errorSpans"><?php echo $errorsMessages['d_price'] ?></span></span><br/>
