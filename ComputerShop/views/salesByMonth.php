...
<h2 class='sectionTitle'>view sales in a  year</h2>
 ...
 <?php
        ...
        <select id="salesMonth" name="salesMonth" class="<?php  $st = ";document.getElementsByClassName('errorSpans')[1].innerHTML = ' '";$st1="this.className ='recoveryFields'" ;if(!empty($errorsMessages['salesMonth']))echo "errorFields\"oninput = \"$st1$st\"";?>">      
   <?php
       ...
       if($sales==false)
       {
      echo "<h2 class='generalmessage'>there is no sales in this month</h2>";
       }
